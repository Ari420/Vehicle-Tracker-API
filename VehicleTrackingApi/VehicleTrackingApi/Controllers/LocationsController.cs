...
namespace VehicleTrackingApi.Controllers
{
    public class LocationsController : ApiController
    {
        ...
        public LocationsController()
        {
            ...
            _geoHelper = new GeoHelper(_httpHelper);

        }
        public string GetCurrentLocation(string ipAddress)
        {

            return _geoHelper.GetGeoInfo(ipAddress).Result;
        }
        // GET: Location
        public string GetLocation()
        {
            return _geoHelper.GetGeoInfo().Result;
        }
        // GET: api/Locations
